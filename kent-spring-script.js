(function () {
  ...
  const CIRCLE_SIZE = window.matchMedia('(max-width: 639px)').matches ? 78 : 100;
  const LIGHT_CIRCLE_WIDTH = window.matchMedia('(max-width: 639px)').matches ? 100 : 120;
  const LIGHT_CIRCLE_HEIGHT = window.matchMedia('(max-width: 639px)').matches ? 100 : 120;
